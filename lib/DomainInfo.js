...
function DomainInfo(json, updater){
    ...
    this.addResourceParent = function(resourceId, parentId){

    }

    this.addAgentParent = function(agentId, parentId){

    }

    this.grant = function(agentId,  resourceId){

    }

    this.allow = function(agentId,  resourceId){
...
var contract1 = $$.contract.create("name", "ctor",...);
