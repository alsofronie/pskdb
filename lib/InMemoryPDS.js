...
function InMemoryPDS(permanentPersistence, shareHoldersCount){
    ...
    this.commit = function(blockSet, currentPulse){
        ...
        if(permanentPersistence) {
            permanentPersistence.persist(blockSet, mainStorage.getInternalValues(currentPulse), currentPulse);
        }
    }
